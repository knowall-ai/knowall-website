...
export default function PrivacyPolicyPage() {
  return (
    <PolicyLayout title="Privacy Policy">
      ...
      <h2 className="text-2xl font-semibold mt-8 mb-4 text-white">What goes over Nostr</h2>
      ...
      <h2 className="text-2xl font-semibold mt-8 mb-4 text-white">What we use your details for</h2>
      <p>
      ...
      <h2 className="text-2xl font-semibold mt-8 mb-4 text-white">Payments</h2>
      <p>
